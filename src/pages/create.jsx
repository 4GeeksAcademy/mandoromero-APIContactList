...
const Create = () => {
    ...
    <form onSubmit={handleSubmit} style={{ backgroundColor: "#8092ac", color: "#060000", padding: "20px", borderRadius: "5px" }}>
        <div style={{ marginBottom: "10px" }}>
            ...
            <input id="fullName" type="text" onChange={(e) => setName(e.target.value)} placeholder="Full Name" style={{ width: "100%", padding: "8px", boxSizing: "border-box", backgroundColor: "#08415c", color: "#ffffff", border: "none", borderRadius: "3px" }} />
        </div>
        <div style={{ marginBottom: "10px" }}>
            <label htmlFor="address" style={{ display: "block", marginBottom: "5px" }}>Address</label>
            <input id="address" type="text" onChange={(e) => setAddress(e.target.value)} placeholder="Address" style={{ width: "100%", padding: "8px", boxSizing: "border-box", backgroundColor: "#08415c", color: "#ffffff", border: "none", borderRadius: "3px" }} />
        </div>
        <div style={{ marginBottom: "10px" }}>
            <label htmlFor="email" style={{ display: "block", marginBottom: "5px" }}>Email</label>
            <input id="email" type="email" onChange={(e) => setEmail(e.target.value)} placeholder="Email" style={{ width: "100%", padding: "8px", boxSizing: "border-box", backgroundColor: "#08415c", color: "#ffffff", border: "none", borderRadius: "3px" }} />
        </div>
        <div style={{ marginBottom: "10px" }}>
            <label htmlFor="phoneNumber" style={{ display: "block", marginBottom: "5px" }}>Phone Number</label>
            <input id="phoneNumber" type="text" onChange={(e) => setPhoneNumber(e.target.value)} placeholder="Phone Number" style={{ width: "100%", padding: "8px", boxSizing: "border-box", backgroundColor: "#08415c", color: "#ffffff", border: "none", borderRadius: "3px" }} />
        </div>
